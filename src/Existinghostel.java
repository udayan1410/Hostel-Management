...
public class Existinghostel implements ActionListener{
	...
	Existinghostel(String hostel)
	{
		...
		String str = "select id,name,hostel,room_no from student_info where hostel='"+hostel+"'";
