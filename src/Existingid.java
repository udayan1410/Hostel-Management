...
public class Existingid implements ActionListener{
	...
	Existingid(String pid)
	{
		...
		String str = "select id,name,hostel,room_no from student_info where id="+pid;
